...
public class CountryController {
    ...
    public String update(@ModelAttribute("Country")Country country, RedirectAttributes redirectAttributes) {
        try {
    ...
    public String AddCountry( @ModelAttribute("Country") @Valid  CountryDto country,BindingResult bindingResult, RedirectAttributes redirectAttributes) {
